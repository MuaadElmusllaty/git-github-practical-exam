# Day 1 - Task 1: Basic Git Setup (10 points)

## 🎯 Objective: 
Set up your exam workspace and practice basic Git commands.

## 📝 Steps to Complete:

### Step 1: Create Your Exam Branch
```bash
...
```bash
# Edit the file `file-to-edit.txt` in this folder
